...
const routes: Routes = [
  ...
  {path: 'admin', component: AdminComponent, canActivate: [AdminAutorisatieGuard],
    children: [
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: '', component: AdminHomeComponent, pathMatch: 'full', canActivate: [AdminAutorisatieGuard]},
      { path: "beheer-traject", component: BeheerTrajectComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "traject-toevoegen", component: TrajectToevoegenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "traject-wijzigen/:id", component: TrajectWijzigenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "beheer-gebruikers", component: BeheerGebruikersComponent , canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "beheer-trajectgebruikers/:id", component: BeheerTrajectgebruikersComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "gebruikers-toevoegen", component: GebruikersToevoegenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full', canActivate: [AdminAutorisatieGuard]},
      { path: "gebruiker-wijzigen/:id", component: GebruikerWijzigenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "admin-beheer-trajectgebruikers/:id", component: BeheerTrajectgebruikersComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "beheer-resultaten/:id", component: BeheerResultatenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "beheer-assessments", component: BeheerAssessmentsComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '',  redirectTo: 'admin', pathMatch: 'full', canActivate: [AdminAutorisatieGuard]},
      { path: "maak-assessment", component: MaakAssessmentComponent , canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "wijzig-assessment/:id", component: WijzigAssessmentComponent , canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full' , canActivate: [AdminAutorisatieGuard]},
      { path: "resultaat-invoeren/:id", component: ResultaatInvoerenComponent , canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full', canActivate: [AdminAutorisatieGuard] },
      { path: "resultaat-wijzigen/:id", component: ResultaatWijzigenComponent , canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full', canActivate: [AdminAutorisatieGuard] },
      { path: "beheer-tekstobjecten", component: AdminBeheerTekstobjectenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '',  redirectTo: 'admin', pathMatch: 'full', canActivate: [AdminAutorisatieGuard]},
      { path: "tekstobject-wijzigen/:id", component: TekstobjectWijzigenComponent, canActivate: [AdminAutorisatieGuard]},
      { path: '', redirectTo: 'admin', pathMatch: 'full', canActivate: [AdminAutorisatieGuard] },
    ]
  },
